<template>
    <span class="m-spinner">
        <a href="javascript:;" ref="minus" class="minus"></a>
        <input type="text" ref="numInput" :readonly="readonly" disabled v-model="counter" placeholder=""/>
        <a href="javascript:;" ref="add" class="add"></a>
    </span>
</template>
