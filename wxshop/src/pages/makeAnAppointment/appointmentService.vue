    ...
    <section class="c-doc appointmentService">
      <div v-if="tips2" class="windows">
        ...
        <div style="display: flex;" @click="goTo('myCar')">
            <input class="car" type="text" v-model="defaultCar.licensePlate" placeholder="预约车牌号" readonly="readonly">
        ...
        <div class="bottom-box">     
          <div class="type"  @click="goTo('appointmentStore')">
            ...
            <div class="type-bottom" v-if="appointmentObj.orgId == ''">
               ...
               <input type="text" class="type-bottom-text" v-model="orgName" placeholder="请选择预约门店" readonly="readonly">
            </div>
            <div class="type-bottom" v-else>
               <input type="text" class="type-bottom-text-else" v-model="orgName" placeholder="请选择预约门店" readonly="readonly">
            </div>
          </div>
          ...
          <div class="type" @click="openTips">
            ...
            <div class="type-bottom" v-if="Service == ''">
               ...
               <input type="text" class="type-bottom-text" v-model="Service" placeholder="请选择预约类别" readonly="readonly">
            </div>
            <div class="type-bottom" v-else>
               <input type="text" class="type-bottom-text-else" v-model="Service" placeholder="请选择预约类别" readonly="readonly">
            </div>
          </div>
          ...
          <div class="type" @click="goToPersonnel('appointmentTime')">
            ...
            <div class="type-bottom" v-if="appointmentObj.appointTimeStr == ''">
               ...
               <input type="text" class="type-bottom-text" v-model="appointmentObj.appointTimeStr" placeholder="请选择预约时间" readonly="readonly">
            </div>
            <div class="type-bottom" v-else>
               <input type="text" class="type-bottom-text-else" v-model="appointmentObj.appointTimeStr" placeholder="请选择预约时间" readonly="readonly">
            </div>
          </div>
          ...
          <div class="type" @click="goToPersonnel('buttPersonnel')">
            ...
            <div class="type-bottom" v-if="peopleName == ''">
               ...
               <input type="text" class="type-bottom-text" v-model="peopleName" placeholder="请选择接待工作人员" readonly="readonly">
            </div>
            <div class="type-bottom" v-else>
               <input type="text" class="type-bottom-text-else" v-model="peopleName" placeholder="请选择接待工作人员" readonly="readonly">
            </div>
          </div>
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      fetchHomeData(result){
        ...
        this.userOpt = result;
        //判断logo地址是微信头像还是系统图片
        if(this.userOpt.logopath && !this.userOpt.logopath.startsWith('http')){
          ...
          ajaxModel.wxMyCars(this,(result) => {
            ...
            that.appointmentObj.userCarId = that.defaultCar.id;
          })
      },
      //预约类型点击
      mainBtn(pItem){
      ...
      submit() {
        //提交数据
        var that = this;
        if(this.appointmentObj.userCarId==''){
